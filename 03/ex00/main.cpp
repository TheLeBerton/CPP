...
std::string storyOne[] = {
    ...
    "In the dusty wastelands, a lonely ClapTrap named 'Jack' rolls into town... gears squeaking, ego shining.",
    "With dramatic enthusiasm, he points at Davy and yells: 'Prepare to be mildly inconvenienced!'",
    "But karma is quick. A mysterious force hits Jack for 5 damage.",
    "Refusing to accept defeat, Jack tightens a few screws and repairs himself.",
...
std::string storyTwo[] = {
    ...
    "Deep inside an abandoned robot factory, new ClapTraps are being assembled...",
    ...
    "The engineers decide to create a perfect clone using the copy constructor.",
    "Unsatisfied, they grab another empty shell and upload Jack's data using the assignment operator.",
    "Someone forgets to fill the registration form... an empty identity is created.",
